//altsyncram CBX_SINGLE_OUTPUT_FILE="ON" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" INIT_FILE="Tokyo_Ghoul.mif" INTENDED_DEVICE_FAMILY=""Cyclone V"" NUMWORDS_A=101 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" POWER_UP_UNINITIALIZED="FALSE" READ_DURING_WRITE_MODE_PORT_A="NEW_DATA_NO_NBE_READ" WIDTH_A=0 WIDTH_B=1 WIDTH_BYTEENA_A=1 WIDTH_BYTEENA_B=1 WIDTH_ECCSTATUS=3 WIDTHAD_A=7 WIDTHAD_B=1 address_a clock0 q_a
...
module  mgl6b1
	...
	defparam
		...
		mgl_prim1.init_file = "Tokyo_Ghoul.mif",
		mgl_prim1.intended_device_family = ""Cyclone V"",
		mgl_prim1.numwords_a = 101,
